          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="images/nilimage.jpeg" alt="..." class="img-circle profile_img" style="width:70px;height:100px;">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="index.php"><i class="fa fa-home"></i> Panel Anasayfa </a></li>
                  <li><a><i class="fa fa-cog"></i>Ayarlar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="about_us.php">Hakkımda</a></li>
                      <li><a href="skills.php">Yetenekler</a></li>
                      <li><a href="info.php">Bilgiler</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/nilimage.jpeg" style= " width:40px; height:65px;" alt=""><?php echo $fetch['user_name']; ?>
